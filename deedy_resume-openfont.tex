...
\begin{minipage}[t]{0.33\textwidth}
    ...
    \\ do Pará}
    \descript{BS in Computer Engineering | Undergraduate}
    \location{ Jun 2017 | Belém, PA}
    \sectionsep
...
\begin{minipage}[t]{0.66\textwidth}
    ...
    \location{Apr 2014 - May 2015 | Belém, PA}
    %\vspace{\topsep} % Hacky fix for awkward extra vertical space
    \begin{tightemize}
    ...
    \location{May 2011 – Mar 2014 | Belém, PA}
    \begin{tightemize}
