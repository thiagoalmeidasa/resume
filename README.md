...
2. It uses free, open-source fonts that resemble the above - *Lato* (and its various variants) and *Raleway*.
...
![alt tag](https://raw.githubusercontent.com/thiagoalmeidasa/resume/master/sample-image.png)
...
2. Pre built version - [as a direct download](https://github.com/thiagoalmeidasa/resume/raw/master/sample-image.pdf)
